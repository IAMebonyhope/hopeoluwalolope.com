...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <!--<a class="navbar-brand" href="index.html">IAMebonyhope</a>-->
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
						...
						<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
							...
							<li class="ftco-animate"><a href="https://twitter.com/iamebonyhope"><span class="icon-twitter"></span></a></li>
							<li class="ftco-animate"><a href="https://medium.com/@iamebonyhope"><span class="icon-medium"></span></a></li>
							<li class="ftco-animate"><a href="https://adplist.org/mentors/oluwalolope-hope"><span class="icon-chat"></span></a></li>
						  </ul>
					</div>
		          </div>
	        	</div>
